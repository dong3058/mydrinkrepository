...
public enum Oauth2Enum {
    ...
    Kakao("http://localhost:8080/kakao/login","z","https://kauth.kakao.com/oauth/token","https://kapi.kakao.com/v1/oidc/userinfo");
    Oauth2Enum(String redirect_url, String client_id, String request_access_token_url, String request_user_info_url) {
